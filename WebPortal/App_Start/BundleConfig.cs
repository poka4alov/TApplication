...
namespace WebPortal.App_Start
{
	public class BundleConfig
	{
		public static void RegisterBundles(BundleCollection bundles)
		{
			...
			bundles.Add(new StyleBundle("~/Bundles/data_tables")
				.Include("~/Content/js/data_tables/datatables.min.css"));
			...
			// DataTable 
			bundles.Add(new ScriptBundle("~/Bundles/data_table")
				.Include("~/Content/js/data_tables/datatables.min.js"));
